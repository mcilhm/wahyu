...
class EmployeeController extends Controller
{
    ...
    public function getdata()
    {
        ...
        $employee = DB::select('SELECT
                        ...
                        a.`department_id`,
                        a.`section_id`,
                        IF(a.`job_status` = 0, "DL", "IDL") job_status,
                        a.`date_of_entry`,
                        a.`date_of_birthday`,
                        a.`education_id`,
                        a.`work_location`,
                        IF(a.`marital_status` = 0, "Sudah Menikah", "Belum Menikah") marital_status,
                        if(a.`gender` = 0, "Laki-laki", "Wanita") gender,
                        a.`email`,
                        a.`phone_number`,
                        a.`photo`,
                        IF(a.`status` = 0, "PKWT", "PKWTT") status,
                        a.`division_id`,
                        a.`created_at`,
                        a.`updated_at`,
