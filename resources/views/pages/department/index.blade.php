            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="white-box">
                        ...
                        {{ Form::open(array('action' => array('Admin\DepartmentController@store'), 'method' => 'POST' ,'class' => 'form-horizontal','enctype' => 'multipart/form-data')) }}
                            <input type="hidden" name="id" value="{{ isset($department->id) ? $department->id : null }}">
                            <div class="form-group">
                                <label class="control-label">Name</label>
                                <input type="text" required="" class="form-control" placeholder="Name" name="name" value="{{ isset($department->name) ? $department->name : null }}">
                            </div>
                            <div class="form-group">
