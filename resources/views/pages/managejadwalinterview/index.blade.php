                    ...
                    <div class="white-box">
                        ...
                        {{ Form::open(array('action' => array('Admin\ManageJadwalInterviewController@store'), 'method' => 'POST' ,'class' => 'form-horizontal','enctype' => 'multipart/form-data')) }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control" placeholder="Description" name="date_of_interview" max="{{ Carbon\Carbon::parse($submission->date_of_ended_work)->format('Y-m-d') }}">
                            </div>
                            <div class="form-group">
